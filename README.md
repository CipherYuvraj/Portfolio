<p align="center" width="100%">
    <img height="100" src="./public/image/logo.png">
</p>
...
#### A professional portfolio website to showcase your skills, projects, and experience. This website is designed to be user-friendly and easily customizable, making it perfect for both developers and freelancers.
...
## View live preview [here](https://your-portfolio-url.com/).
...
```bash
git clone https://github.com/CipherYuvraj/portfolio.git
...
export const personalData = {
  ...
  facebook: "https://www.facebook.com/yuvrajudaywal/",
  linkedIn: "www.linkedin.com/in/yuvraj-udaywal-7a5ba9275",
  twitter: "https://twitter.com/YuvrajUdaywal",
};
```
...
3. Select your **GitHub repo** (the one that contains your project) and click **Import**.
